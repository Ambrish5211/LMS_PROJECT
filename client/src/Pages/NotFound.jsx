        ...
        <div className="h-screen w-full flex flex-col justify-center items-center bg-[#1A2238]">
            ...
            <button className="mt-5">
                <a onClick={() => navigate(-1)} className="relative inline-block text-sm font-medium text-[#FF6A3D] active:text-yellow-500 focus:outline-none">
                    <span  className="relative block px-8 py-3 bg-[#1A2238] border border-current hover:bg-yellow-600 hover:text-gray-100 transform hover:scale-105">Go back</span>
                </a>
            </button>
        </div>
    );
